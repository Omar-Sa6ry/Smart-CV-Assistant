      ...
      const base = await tx.cvAnalysisBase.create({
        data: {
          ...
          atsDetails: {
            create: {
              ...aiResult.atsDetails,
              foundKeywordsList: aiResult.atsDetails?.foundKeywordsList
                ? JSON.stringify(aiResult.atsDetails.foundKeywordsList)
                : null,
              missingKeywordsList: aiResult.atsDetails?.missingKeywordsList
                ? JSON.stringify(aiResult.atsDetails.missingKeywordsList)
                : null,
            },
          },
          contentDetails: {
            create: {
              ...
              spellingErrorsList: aiResult.contentDetails?.spellingErrorsList
                ? JSON.stringify(aiResult.contentDetails.spellingErrorsList)
                : null,
            },
          },
          completenessDetails: {
